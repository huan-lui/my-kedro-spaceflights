...
# my_kedro_spaceflights documentation build
...
from my_kedro_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "my_kedro_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "my_kedro_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "my_kedro_spaceflights.tex",
        "my_kedro_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "my_kedro_spaceflights",
        "Project my_kedro_spaceflights codebase.",
        "Data-Science",
    )
]
